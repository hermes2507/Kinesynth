...
, 			{
				"box" : 				{
					...
					"text" : "Switch de cabeza desactiva el control de pitch por distancia de manos y permite controlar Range con distancia entre manos y offset con distancia de manos desde el torso hacia arriba. (torso es 1, el màximo es configurado)\n\nAl usar el control de cabeza el parámetro(s) activo se bloquea en el ultimo valor."
				}
